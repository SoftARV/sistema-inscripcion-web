...
CREATE TABLE IF NOT EXISTS `sistema_inscripcion_bd`.`seccion` (
  ...
  INDEX `fk_seccion_profesor1_idx` (`profesor_idProfesor` ASC),
...
CREATE TABLE IF NOT EXISTS `sistema_inscripcion_bd`.`inscripcion` (
  ...
  INDEX `fk_inscripcion_seccion1_idx` (`seccion_idSeccion` ASC),
  ...
  CONSTRAINT `fk_inscripcion_seccion1`
    ...
    REFERENCES `sistema_inscripcion_bd`.`seccion` (`idSeccion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Data for table `sistema_inscripcion_bd`.`persona`
-- -----------------------------------------------------
START TRANSACTION;
USE `sistema_inscripcion_bd`;
INSERT INTO `sistema_inscripcion_bd`.`persona` (`idPersona`, `cedula`, `nombre`, `apellido`, `telefono`) VALUES (1, '20986889', 'Miguel', 'Rincon', '04126635928');
...
-- -----------------------------------------------------
-- Data for table `sistema_inscripcion_bd`.`usuario`
-- -----------------------------------------------------
START TRANSACTION;
USE `sistema_inscripcion_bd`;
INSERT INTO `sistema_inscripcion_bd`.`usuario` (`idUsuario`, `correo`, `password`, `persona_idPersona`, `perfil_idPerfil`) VALUES (1, 'miguelaezak@gmail.com', '1234', 1, 1);
...
START TRANSACTION;
USE `sistema_inscripcion_bd`;
INSERT INTO `sistema_inscripcion_bd`.`curso` (`idCurso`, `nombreCurso`) VALUES (1, 'CCNA I');
INSERT INTO `sistema_inscripcion_bd`.`curso` (`idCurso`, `nombreCurso`) VALUES (2, 'CCNA II');
INSERT INTO `sistema_inscripcion_bd`.`curso` (`idCurso`, `nombreCurso`) VALUES (3, 'CCNA III');
INSERT INTO `sistema_inscripcion_bd`.`curso` (`idCurso`, `nombreCurso`) VALUES (4, 'CCNA IV');
INSERT INTO `sistema_inscripcion_bd`.`curso` (`idCurso`, `nombreCurso`) VALUES (5, 'IT Essential');
